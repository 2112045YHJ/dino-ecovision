        ...
        <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <article className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 text-xs text-gray-500">
              현재는 더미데이터 기준 화면입니다. 추후 `/api/world/current` API가
              생기면 실제 전력/탄소 상태로 교체하면 됩니다.
            </p>
          </article>
          ...
          <article className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-2xl bg-[#FAF9F5] p-4">
                <p className="text-sm text-gray-600">진행 시간</p>
            ...
            <p className="mt-4 text-xs text-gray-500">
              현재는 더미데이터 기준 화면입니다. 추후 `/api/dungeons/active`
              API가 생기면 실제 던전 이벤트로 교체하면 됩니다.
            </p>
          </article>
        </section>
      </section>
